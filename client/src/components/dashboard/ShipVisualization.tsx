  ...
  return (
    ...
    >
      <div className="p-4 border-b border-[#415A77] flex justify-between items-center">
        <h2 className="text-lg font-medium text-[#E0E1DD]">
        ...
        >
          {isFullscreen ? (
            ...
            >
              <path
                fillRule="evenodd"
                d="M5 9V7a2 2 0 012-2h2a1 1 0 000-2H7a4 4 0 00-4 4v2a1 1 0 002 0zm10 0V7a4 4 0 00-4-4h-2a1 1 0 000 2h2a2 2 0 012 2v2a1 1 0 102 0zM5 11v2a2 2 0 002 2h2a1 1 0 010 2H7a4 4 0 01-4-4v-2a1 1 0 012 0zm10 0v2a4 4 0 01-4 4h-2a1 1 0 010-2h2a2 2 0 002-2v-2a1 1 0 012 0z"
                clipRule="evenodd"
              />
            </svg>
          ) : (
      ...
      <div
        className={`${isFullscreen ? "h-[calc(100vh-64px)]" : "p-4 h-[400px]"}`}
      >
        <div className="relative w-full h-full rounded-lg overflow-hidden">
          <ShipModel />
          <div className="absolute top-2 left-2 text-[#E0E1DD] bg-[#0D1B2A] bg-opacity-50 p-2 rounded">
            <h3 className="font-bold text-sm">Merchant Vessel</h3>
            <p className="text-xs">
              Length: 270m • Type: Cargo • Capacity: 45,000 tons
            </p>
          </div>
